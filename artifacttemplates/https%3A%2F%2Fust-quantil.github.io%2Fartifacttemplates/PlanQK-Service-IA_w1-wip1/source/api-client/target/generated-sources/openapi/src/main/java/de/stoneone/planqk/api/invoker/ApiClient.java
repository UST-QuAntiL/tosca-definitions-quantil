package de.stoneone.planqk.api.invoker;
...
import de.stoneone.planqk.api.invoker.auth.HttpBasicAuth;
import de.stoneone.planqk.api.invoker.auth.HttpBearerAuth;
import de.stoneone.planqk.api.invoker.auth.ApiKeyAuth;
import de.stoneone.planqk.api.invoker.ApiResponseDecoder;

import de.stoneone.planqk.api.invoker.auth.ApiErrorDecoder;
import de.stoneone.planqk.api.invoker.auth.OAuth;
import de.stoneone.planqk.api.invoker.auth.OAuth.AccessTokenListener;
import de.stoneone.planqk.api.invoker.auth.OAuthFlow;
import de.stoneone.planqk.api.invoker.auth.OauthPasswordGrant;
import de.stoneone.planqk.api.invoker.auth.OauthClientCredentialsGrant;
...
public class ApiClient {
  ...
  private String basePath = "https://platform.planqk.de/qc-catalog";
  ...
  public ApiClient(String[] authNames) {
    ...
    for(String authName : authNames) {
      ...
      if ("apiKey".equals(authName)) {
        auth = new ApiKeyAuth("header", "X-Auth-Token");
      } else if ("oauth2".equals(authName)) {
        auth = buildOauthRequestInterceptor(OAuthFlow.PASSWORD, "", "https://platform.planqk.de/auth/realms/planqk/protocol/openid-connect/token", "profile");
      } else {
