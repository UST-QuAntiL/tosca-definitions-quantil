...
@Endpoint
public class PlanQKServiceManagementInterfaceEndpoint {

    private static final Logger LOG = LoggerFactory.getLogger(PlanQKServiceManagementInterfaceEndpoint.class);

    @PayloadRoot(namespace = PlanQKServiceConstants.NAMESPACE_URI, localPart = "createRequest")
    ...
    @PayloadRoot(namespace = PlanQKServiceConstants.NAMESPACE_URI, localPart = "terminateRequest")
