...
public abstract class PlanQKPlatformConstants {

    // Namespace under which the SOAP service operates
    public static final String NAMESPACE_URI = "https://ust-quantil.github.io/artifacttemplates";

    // Port type to use for the SOAP service
    public static final String PORT_TYPE_NAME = "io_github_ust_quantil_artifacttemplates_PlanQKPlatform__ContainerManagementInterfacePort";
